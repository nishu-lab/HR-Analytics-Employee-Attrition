...
-- Purpose  : Creates the HR employee table used for SQL
--            analysis and Power BI dashboard reporting.
-- ==========================================================

-- Dataset Import
-- The HR employee dataset is imported into the hr_data table
-- using the pgAdmin Import/Export Data tool after the table
